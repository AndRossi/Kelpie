...
def rbo(original_model: ComplEx,
    ...
    for i in range(len(original_samples)):
        ...
        rbos.append(ranking_similarity.compute_rbo(original_head_predictions, kelpie_head_predictions))
        rbos.append(ranking_similarity.compute_rbo(original_tail_predictions, kelpie_tail_predictions))

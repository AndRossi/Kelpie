...
def rbo(original_model: ComplEx,
    ...
    for i in range(len(original_samples)):
        ...
        original_head_predictions = original_head_predictions[:original_target_head_index + 1]
        kelpie_head_predictions = kelpie_head_predictions[:kelpie_target_head_index + 1]
        ...
        original_tail_predictions = original_tail_predictions[:original_target_tail_index + 1]
        kelpie_tail_predictions = kelpie_tail_predictions[:kelpie_target_tail_index + 1]

        rbos.append(ranking_similarity.compute_rbo_2(original_head_predictions, kelpie_head_predictions))
        rbos.append(ranking_similarity.compute_rbo_2(original_tail_predictions, kelpie_tail_predictions))

...
from rule_extraction.dp_necessary_extractor import DataPoisoningNecessaryRuleExtractor
from rule_extraction.dp_sufficient_extractor import DataPoisoningSufficientRuleExtractor
...
class Kelpie:
    ...
    def explain_necessary(self,
        ...
        rule_extractor = DataPoisoningNecessaryRuleExtractor(model=self.model,
    ...
    def explain_sufficient(self,
        ...
        rule_extractor = DataPoisoningSufficientRuleExtractor(model=self.model,
                                                              dataset=self.dataset,
                                                              hyperparameters=self.hyperparameters,
                                                              sample_to_explain=sample_to_explain,
                                                              perspective=perspective,

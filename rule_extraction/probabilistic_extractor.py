...
class ProbabilisticSufficientRuleExtractor(SufficientRuleExtractor):

    """
    The ProbabilisticSufficientRuleExtractor object guides the search for sufficient rules with a probabilistic policy
    """
    ...
    def extract_rules_with_length(self,
        ...
        while i < len(all_possible_rules_with_preliminary_scores) and not terminate:
            ...
            # if the window had not been filled yet, continue

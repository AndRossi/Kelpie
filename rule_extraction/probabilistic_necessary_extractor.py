...
class ProbabilisticNecessaryRuleExtractor(NecessaryRuleExtractor):

    """
    The ProbabilisticNecessaryRuleExtractor object guides the search for necessary rules with a probabilistic policy
    """

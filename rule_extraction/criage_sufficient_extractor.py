...
class CriageSufficientRuleExtractor(SufficientRuleExtractor):

    """
    The CriageSufficientRuleExtractor object guides the search for sufficient rules following the Criage approach
    """
    def __init__(self, model: Model,
        ...
        """
        CriageSufficientRuleExtractor object constructor.

...
In FB15k and FB15k-237, on the contrary, entities tend to have far more mentions in training (in average, 64.5 in FB15k and 34.5 in FB15k-237): this makes the choice of _k_ value more relevant, so and varying it leads to slightly more visible consequences. In this cases, as a general rule, greater _k_ values lead to better or equal explanations, at the cost of extending the research space. 

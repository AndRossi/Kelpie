...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/explanation_minimality/kelpie_necessary_complex_fb15k_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_sufficient_complex_fb15k_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_necessary_complex_wn18_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_sufficient_complex_wn18_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_necessary_complex_fb15k237_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_sufficient_complex_fb15k237.csv_sampled && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_necessary_complex_wn18rr_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_sufficient_complex_wn18rr_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_necessary_complex_yago310_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_sufficient_complex_yago310_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_necessary_conve_fb15k_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_sufficient_conve_fb15k_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_necessary_conve_wn18_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_sufficient_conve_wn18_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_necessary_conve_fb15k237_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_sufficient_conve_fb15k237_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_necessary_conve_wn18rr_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_sufficient_conve_wn18rr_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_necessary_conve_yago310_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_sufficient_conve_yago310_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_necessary_transe_fb15k_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_sufficient_transe_fb15k_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_necessary_transe_wn18_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_sufficient_transe_wn18_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_necessary_transe_fb15k237_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_sufficient_transe_fb15k237_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_necessary_transe_wn18rr_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_sufficient_transe_wn18rr_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_necessary_transe_yago310_sampled.csv && \
rm output_*.csv && \
...
mv output_end_to_end_skipping_random_facts.txt scripts/experiments/end_to_end/kelpie_sufficient_transe_yago310_sampled.csv && \
rm output_*.csv
